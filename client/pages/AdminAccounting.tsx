...
export default function AdminAccounting() {
  ...
  const cashFlow = useMemo(() => {
    const paid = mockExpenses
      .filter((e) => e.status === "paid")
      .reduce((sum, e) => sum + e.amount, 0);
    const pending = mockExpenses
      .filter((e) => e.status === "pending")
      .reduce((sum, e) => sum + e.amount, 0);
    const overdue = mockExpenses
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-slate-600 mt-2">
              View financial overview and manage accounting
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <div
                className={`p-3 rounded-lg ${
                  profitLoss.grossProfit >= 0 ? "bg-blue-200" : "bg-orange-200"
                }`}
              >
                <TrendingUp
                  className={`w-6 h-6 ${
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <div
                className={`p-3 rounded-lg ${
                  profitLoss.netProfit >= 0 ? "bg-purple-200" : "bg-red-200"
                }`}
              >
                <DollarSign
                  className={`w-6 h-6 ${
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between pb-3 border-b border-slate-200">
                ...
                <span className="font-bold text-red-600">
                  -${profitLoss.operatingExpenses.toLocaleString()}
                </span>
              </div>
              <div className="flex items-center justify-between pb-3 border-b border-slate-200">
                <span className="text-slate-600">Payroll Costs</span>
                <span className="font-bold text-red-600">
                  -${profitLoss.payroll.toLocaleString()}
                </span>
              </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between pb-3 border-b border-slate-200">
                ...
                <span className="font-bold text-slate-900">
                  ${budgetData.budgeted.toLocaleString()}
                </span>
              </div>
              <div className="flex items-center justify-between pb-3 border-b border-slate-200">
                <span className="text-slate-600">Actual Spending</span>
                <span className="font-bold text-slate-900">
                  ${budgetData.actual.toLocaleString()}
                </span>
              </div>
              <div className="flex items-center justify-between pt-3">
                ...
                >
                  ...
                  <span className="text-sm ml-2">
                    ({budgetData.variancePercent.toFixed(1)}%)
                  </span>
                </span>
              </div>
            </div>
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-2xl font-bold text-yellow-700">
                    ${cashFlow.pending.toLocaleString()}
                  </span>
                </div>
              </div>
              <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-2xl font-bold text-red-700">
                    ${cashFlow.overdue.toLocaleString()}
                  </span>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Link to="/admin/accounting/cash-flow">
            <div className="bg-white rounded-lg border border-slate-200 p-6 hover:shadow-lg transition cursor-pointer">
              ...
              <p className="text-sm text-slate-600">
                Monitor cash movement and liquidity
              </p>
            </div>
          </Link>
