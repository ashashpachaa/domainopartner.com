...
export default function AdminCashFlow() {
  const cashFlowData = useMemo(() => {
    ...
    const operatingCashFlow = netIncome + depreciationAmortization + changesInWorkingCapital;
      ...
      <div className="p-8 space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-slate-600 mt-2">Monitoring cash movements and liquidity</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg border border-green-200 p-6">
            <p className="text-green-700 text-sm font-medium">Beginning Cash Balance</p>
          ...
          <div className="bg-gradient-to-br from-purple-50 to-indigo-50 rounded-lg border border-purple-200 p-6">
            <p className="text-purple-700 text-sm font-medium">Ending Cash Balance</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-lg border border-slate-200 overflow-hidden">
            <div className="bg-green-50 border-b border-green-200 p-6">
              <h2 className="text-lg font-bold text-green-900">OPERATING ACTIVITIES</h2>
            </div>
            ...
            <div className="p-6 space-y-3">
              ...
              <div className="flex justify-between text-slate-600">
                ...
                <span>+${cashFlowData.operating.depreciationAmortization.toLocaleString()}</span>
              </div>
              <div className="flex justify-between text-slate-600">
                <span>Changes in Working Capital</span>
                <span>+${cashFlowData.operating.changesInWorkingCapital.toLocaleString()}</span>
              </div>
          ...
          <div className="bg-white rounded-lg border border-slate-200 overflow-hidden">
            <div className="bg-blue-50 border-b border-blue-200 p-6">
              <h2 className="text-lg font-bold text-blue-900">INVESTING ACTIVITIES</h2>
            </div>

            <div className="p-6 space-y-3">
              <div className="flex justify-between text-slate-600">
                <span>Capital Expenditures</span>
                <span>-${cashFlowData.investing.capitalExpenditures.toLocaleString()}</span>
              </div>
              <div className="flex justify-between text-slate-600">
                <span>Other Investments</span>
                <span>-${cashFlowData.investing.otherInvestments.toLocaleString()}</span>
              </div>

              <div className="border-t border-slate-200 pt-3 flex justify-between font-bold text-slate-900">
                <span>Investing Cash Flow</span>
                <span className="text-red-600">${cashFlowData.investing.total.toLocaleString()}</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg border border-slate-200 overflow-hidden">
            <div className="bg-purple-50 border-b border-purple-200 p-6">
              <h2 className="text-lg font-bold text-purple-900">FINANCING ACTIVITIES</h2>
            </div>

            <div className="p-6 space-y-3">
              <div className="flex justify-between text-slate-600">
                <span>Debt Repayment</span>
                <span>-${cashFlowData.financing.debtRepayment.toLocaleString()}</span>
              </div>
              <div className="flex justify-between text-slate-600">
                <span>Equity Raised</span>
                <span>+${cashFlowData.financing.equityRaised.toLocaleString()}</span>
              </div>
              <div className="flex justify-between text-slate-600">
                <span>Dividends Paid</span>
                <span>-${cashFlowData.financing.dividendsPaid.toLocaleString()}</span>
              </div>

              <div className="border-t border-slate-200 pt-3 flex justify-between font-bold text-slate-900">
                <span>Financing Cash Flow</span>
                <span className="text-red-600">${cashFlowData.financing.total.toLocaleString()}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-slate-50 to-slate-100 rounded-lg border border-slate-200 p-8">
          <h2 className="text-2xl font-bold text-slate-900 mb-6">Cash Position Analysis</h2>

          <div className="space-y-6">
            {/* Cash Flow Waterfall */}
            <div>
              <h3 className="font-bold text-slate-900 mb-4">Cash Flow Waterfall</h3>
              <div className="space-y-3">
                <div className="flex items-center gap-4">
                  <div className="w-32">
                    <p className="text-sm font-medium text-slate-600">Beginning Cash</p>
                  </div>
                ...
                <div className="flex items-center gap-4">
                  <div className="w-32">
                    <p className="text-sm font-medium text-green-600">+ Operating</p>
                  </div>
                ...
                <div className="flex items-center gap-4">
                  <div className="w-32">
                    <p className="text-sm font-medium text-red-600">- Investing</p>
                  </div>
                ...
                <div className="flex items-center gap-4">
                  <div className="w-32">
                    <p className="text-sm font-medium text-red-600">- Financing</p>
                  </div>
                  <div className="flex-1 bg-red-300 h-8 rounded flex items-center px-3">
                    <p className="text-sm font-bold text-red-900">
                ...
                <div className="flex items-center gap-4 pt-2 border-t border-slate-300">
                  <div className="w-32">
                    <p className="text-sm font-bold text-slate-900">Ending Cash</p>
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-white rounded-lg p-4 border border-slate-200">
                <p className="text-slate-600 text-sm">Operating Cash Flow Ratio</p>
                <p className="text-2xl font-bold text-slate-900 mt-2">
                  {((cashFlowData.operating.total / mockOrders.filter(o => o.status === "completed").reduce((sum, o) => sum + o.amount, 0)) * 100).toFixed(1)}%
                </p>
              </div>
              ...
              <div className="bg-white rounded-lg p-4 border border-slate-200">
                ...
                <p className={`text-2xl font-bold mt-2 ${
                  cashFlowData.operating.total + cashFlowData.investing.total >= 0
                    ? "text-green-600"
                    : "text-red-600"
                }`}>
                  ${(cashFlowData.operating.total + cashFlowData.investing.total).toLocaleString()}
                </p>
              </div>
              ...
              <div className="bg-white rounded-lg p-4 border border-slate-200">
                ...
                <p className={`text-2xl font-bold mt-2 flex items-center gap-2 ${
                  ...
                  {cashFlowData.netCashChange >= 0 ? <ArrowUpRight className="w-5 h-5" /> : <ArrowDownLeft className="w-5 h-5" />}
