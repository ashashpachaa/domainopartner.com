...
export default function AdminUKCompanySetup() {
  ...
  const handleSubmitIncorporationToCompaniesHouse = (inc: CompanyIncorporation) => {
    const autoGeneratedNumber = generateCompanyNumber();
    const updated = {
      ...inc,
      status: "submitted" as const,
      filingReference: `CH-${Date.now()}`,
      companyRegistrationNumber: autoGeneratedNumber,
    ...
    setEditingCompanyNumber(autoGeneratedNumber);
    setShowDetailModal(false);
    toast.success(`Company submitted! Temporary Reference: ${autoGeneratedNumber}`);
  };
