...
export default function AdminWorkflowSettings() {
  ...
  const handleReset = () => {
    if (confirm("Are you sure you want to reset to default deadlines?")) {
      setDeadlines(mockStageDeadlines);
      localStorage.setItem("stageDeadlines", JSON.stringify(mockStageDeadlines));
      setUnsavedChanges(false);
  ...
  const stageCategories = [
    ...
    },
    {
      ...
      stages: ["Apostille Processing", "Power of Attorney", "Financial Report", "Shipping & Tracking"],
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            <Button
              ...
              className={unsavedChanges ? "bg-green-600 hover:bg-green-700" : "bg-slate-400"}
            >
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-8">
          <p className="text-sm text-blue-900">
            <strong>Note:</strong> Deadline values can be entered as decimal numbers.
            For example: 0.25 = 6 hours, 0.5 = 12 hours, 1 = 1 day, 3 = 3 days.
            Changes will apply to all new orders created after saving.
          </p>
        </div>
                        ...
                        {deadline.lastUpdatedBy && (
                          <div className="mt-3 text-xs text-slate-500">
                            <p>
                              ...
                              {new Date(deadline.lastUpdatedAt || "").toLocaleDateString()}
                            </p>
                          </div>
                        )}
                      </div>
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-lg p-6 mt-10">
          <h3 className="font-semibold text-slate-900 mb-3">How Deadlines Work</h3>
          <ul className="space-y-2 text-sm text-slate-700">
            <li>
              • <strong>Cumulative:</strong> Deadlines are calculated cumulatively from order creation
              date.
            </li>
            <li>
              • <strong>Business Days:</strong> Only business days (Mon-Fri) are counted for deadlines
              of 1 day or more.
            </li>
            <li>
              • <strong>Hours:</strong> For durations less than 1 day (0.25 = 6 hours), clock time is
              used instead of business days.
            </li>
            <li>
              • <strong>Global Effect:</strong> Changes will apply to all new orders, not existing
              ones.
            </li>
            <li>
