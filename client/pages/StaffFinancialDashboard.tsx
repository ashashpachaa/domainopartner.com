...
export default function StaffFinancialDashboard() {
  ...
  const financialMetrics = useMemo(() => {
    ...
    const pendingCommission =
      pendingInvoices.length > 0 ? baseCommission * 0.5 : 0;
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-600">
            Your financial summary and pending payments
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
          ...
          <div className="bg-white rounded-lg p-6 border border-slate-200 shadow-sm">
            ...
            <div className="flex justify-between text-xs text-slate-600 mt-2">
              <span>
                Base: ${(financialMetrics.baseCommission / 1000).toFixed(1)}K
              </span>
              <span>
                +Bonus: ${(financialMetrics.performanceBonus / 1000).toFixed(1)}
                K
              </span>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center p-3 bg-slate-50 rounded-lg">
              ...
              <span className="text-lg font-bold text-slate-900">
                {financialMetrics.paidOrderCount}
              </span>
            </div>
            <div className="flex justify-between items-center p-3 bg-slate-50 rounded-lg">
              <span className="text-sm font-medium text-slate-700">
            ...
            <div className="flex justify-between items-center p-3 bg-purple-50 rounded-lg border border-purple-200">
              <span className="text-sm font-medium text-slate-700">
                Performance Bonus (+{financialMetrics.performanceScore}%)
              </span>
          ...
          <div className="bg-white rounded-lg border border-slate-200 overflow-hidden shadow-sm">
            <div className="p-6 border-b border-slate-200">
              <h2 className="text-lg font-bold text-slate-900 flex items-center gap-2">
                ...
                {financialMetrics.pendingInvoices.length})
              </h2>
              <p className="text-sm text-slate-600 mt-1">
                Total pending: $
                {financialMetrics.pendingInvoices.reduce(
        ...
        {financialMetrics.pendingInvoices.length === 0 && (
          <div className="bg-green-50 border border-green-200 rounded-lg p-8 text-center">
            ...
            <p className="text-sm text-green-700 mt-1">
              All your client invoices have been paid!
            </p>
          </div>
        )}
      </div>
